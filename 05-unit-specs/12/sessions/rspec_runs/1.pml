...
[31m      responds with a 200 (FAILED - 2)[0m
    when there are no expenses on the given date
[31m      responds with a 200 (FAILED - 3)[0m
[31m      returns an empty array as JSON (FAILED - 4)[0m
  POST /expenses
...
Failures:
  ...
  given date returns the expense records as JSON
     ...
     [31m    [0m.with([31m[1;31m'[0m[31m2015-12-31[1;31m'[0m[31m[0m)[0m
  ...
  given date responds with a 200
     [31mFailure/Error:[0m
     [31m  [0m[32mallow[0m(ledger).to receive([33m:expenses_on[0m)[0m
     [31m    [0m.with([31m[1;31m'[0m[31m2015-12-31[1;31m'[0m[31m[0m)[0m
     [31m    [0m.and_return([[31m[1;31m'[0m[31mexpense_1[1;31m'[0m[31m[0m, [31m[1;31m'[0m[31mexpense_2[1;31m'[0m[31m[0m])[0m
  ...
  the given date responds with a 200
     [31mFailure/Error:[0m
     [31m  [0m[32mallow[0m(ledger).to receive([33m:expenses_on[0m)[0m
     [31m    [0m.with([31m[1;31m'[0m[31m2015-12-31[1;31m'[0m[31m[0m)[0m
...
Finished in 0.02633 seconds (files took 0.10794 seconds to load)
...
/expenses/:date when expenses exist on the given date responds with a 200[0m
...
200[0m
[31mrspec ./spec/unit/app/api_spec.rb:89[0m [36m# ExpenseTracker::API GET              ↩
